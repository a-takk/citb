      ...
      <div className="privacybackground">
        <div className="privacycontainer">
          ...
          <p>
            ...
            shares, and protects personal information in relation to visitors
            and users of our website.
          </p>

          <h2>Collection of Personal Information</h2>
          <p>
            We collect personal information from visitors and users of our
            website through various means, including:
          </p>
          <ul>
            <li>
              When you provide us with your personal details, such as your name,
              email address, phone number, or address during the booking
              process.
            </li>
          ...
          <ul>
            ...
            <li>
              To comply with legal obligations or in response to lawful
              requests.
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              To object to the processing of your personal information for
